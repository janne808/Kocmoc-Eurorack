...
\item For through-hole board, connect the boards with the headers and M3 screw for the PCB standoff
\end{itemize}
...
\cite{johnson} has researched the failure (with Oscar Salas) and proposed a fix which is implemented in this version of the board.
